...
'''
# 그리드 서치
최적의 매개변수 :  RandomForestClassifier(max_depth=6, min_samples_leaf=3, min_samples_split=10,n_jobs=-1)
...
최적의 매개변수 :  RandomForestClassifier(max_depth=6, min_samples_leaf=5, min_samples_split=3, n_jobs=-1)
...
'''
# 해빙
최적의 매개변수 :  RandomForestClassifier(max_depth=8, min_samples_leaf=3, min_samples_split=5, n_jobs=-1)
최적의 파라미터 :  {'max_depth': 8, 'min_samples_leaf': 3, 'min_samples_split': 5, 'n_estimators': 100, 'n_jobs': -1}
