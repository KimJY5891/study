...
fits
최적의 매개변수 :  RandomForestClassifier(max_depth=8, min_samples_leaf=3, min_samples_split=5,
                       n_estimators=200, n_jobs=-1)     
최적의 파라미터 :  {'n_jobs': -1, 'n_estimators': 200, 'min_samples_split': 5, 'min_samples_leaf': 3, 'max_depth': 8}
best_score_ :  0.9638042005420054
