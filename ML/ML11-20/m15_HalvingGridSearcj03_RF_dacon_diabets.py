...
최적의 매개변수 :  RandomForestClassifier(max_depth=12, min_samples_leaf=10, min_samples_split=10,
                       n_estimators=200, n_jobs=-1)
최적의 파라미터 :  {'max_depth': 12, 'min_samples_leaf': 10, 'min_samples_split': 10, 'n_estimators': 200, 'n_jobs': -1}
best_score_ :  0.758139534883721
model.score :  0.7557251908396947
걸린 시간 :  122.0
acc_score :  0.7557251908396947
최적의 튠  acc :  0.7557251908396947
'''
# 결론 : 그리드 서치 
