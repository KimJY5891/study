...
Index(['hour', 'hour_bef_temperature', 'hour_bef_precipitation',
       'hour_bef_windspeed', 'c', 'hour_bef_visibility',
...
plt.show()
log_list = ['hour_bef_windspeed', 'hour_bef_humidity','hour_bef_visibility','hour_bef_ozone','hour_bef_pm10','hour_bef_pm2.5']
...
# 로그 -> 지수r2 : 0.8107143243761203
# 전환 전 0.7818823404066411
