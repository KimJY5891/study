...
parameters = { "n_estimators" : [600], # 디폴트 100 / 1 ~ inf / 정수
    "learning_rate" : [0.5], # 디폴트 0.3 / 0 ~ 1 / eta
    "max_depth" : [9], # 디폴트 6 / 0 ~ inf / 정수
    "gamma" : [0], # 디폴트 0 / 0 ~ inf 
    "min_child_weight" : [0.001], # 디폴트 1 / 0 ~ inf 
...
'''
최적의 파라미터 :  {'gamma': 0, 'learning_rate': 0.5, 'max_depth': 9, 'n_estimators': 600}
best_score :  0.53082389584216
model.score :  0.5709090909090909
acc_score :  0.5709090909090909
최적의 튠 acc :  0.5709090909090909
'''
#2. 모델 구성
xgb =XGBClassifier()
