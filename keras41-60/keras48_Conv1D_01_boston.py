...
x=datasets.data
y=datasets['target']
print("x_train : ",x.shape) # (354, 13)
print("x_train : ",y.shape) # (354, 13)
...
print("x_train : ",x_train.shape) # (354, 13)
print("x_test : ",x_test.shape) # (152, 13)
print("y_train : ",y_train.shape) # 
print("y_test : ",y_test.shape) # 


#2. 모델 구성
input01=Input(shape=(13,1))
Conv1D01=Conv1D(10,2)(input01)
Conv1D02=Conv1D(10,2)(Conv1D01)
Flatten01=Flatten()(Conv1D02)
Dense01=Dense(1)(Flatten01)
output01=Dense(1)(Dense01)
