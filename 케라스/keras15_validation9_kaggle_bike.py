...
#2. 모델 구성
model =Sequential()
model.add(Dense(300,activation="linear",input_dim=8))
...
hist =model.fit(x_train,y_train,epochs= 1200,batch_size=100,
                ...
                5/5 [==============================] - 0s 12ms/step - loss: 0.1565 - val_loss: 0.1644
Restoring model weights from the end of the best epoch.
Epoch 00202: early stopping
3/3 [==============================] - 0s 2ms/step - loss: 0.1842
loss:  0.1841886043548584
r2 스코어 :  0.25225943855294164
rmse : 0.4291720151135591
"""
